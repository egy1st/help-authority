...
Imports DynamicComponents.HelpAuthority

Namespace DynamicComponents
    Public Class MyProtection
...
#End Region
        ...
        Private ProductNum As String = "19"
...
#End If
            ...
            WinSys = GetFolderPath(SpecialFolder.System) + "\"
            ...
            My.Computer.Registry.CurrentUser.CreateSubKey(LicenseFile)
            ...
            If MyChar1 = Chr(19) Or regValue = Chr(19) Then   'trial version has ended
                ...
                AuthorPrgress.Location = New System.Drawing.Point(115, 140)
            ...
            AuthorLabel3.Location = New System.Drawing.Point(5, 185)
            ...
            AuthorText2.Location = New System.Drawing.Point(115, 185)
            ...
            AuthorLabel4.Text = "Registered To"
            AuthorLabel4.Location = New System.Drawing.Point(5, 225)
            ...
            AuthorText4.MaxLength = 32
            AuthorText4.CreateControl()
            AuthorForm.Controls.Add(AuthorText4)


            AuthorButton1.Location = New System.Drawing.Point(5, 310)
            ...
            AuthorBuyNow.Location = New System.Drawing.Point(170, 310)
            ...
            AuthorButton2.Location = New System.Drawing.Point(305, 310)
            ...
            Dim regdkey As Integer = DecryptMe(regDaysValue)
            ...
            Dim regokey As Integer = DecryptMe(regOldValue)
            ...
            If AuthorButton2.Text = "Activate Trial" Then
                AuthorForm.ShowDialog()
                MachinePrint = getMD5Hash(GetProcessorId())
        ...
        Private Sub AuthorButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
            ...
            str_link += "&para5=" + AuthorText2.Text.Trim
            str_link += "&para6=" + AuthorText3.Text.Trim
            str_link += "&para7=" + AuthorText4.Text.Trim
            str_link += "&para8=" + MachinePrint
            str_link += "&para9=" + ProductNum
            str_link += "&para10=" + ProductV
            str_link += "&para11=" + Reseller
...
Re_Connect:
                ...
                ElseIf str_result = "VALID" Then 'Valid
                    ...
                    FileClose(FileNum)
                    MsgBox("Registration Succeeded" + vbCrLf + "Thank you for purchasing " + ProductID + " " + ProductVer, , ProductID)
                    'str_link += "&download=1"
                    'MsgBox("Registration Succeeded" + vbCrLf + "Thank you for purchasing " + ProductID + " " + ProductVer + vbCrLf + "Please install the registered version you are going to download", , ProductID)
                    'System.Diagnostics.Process.Start(str_link)
                    'Valid = True
                    'AuthorForm.Close()
                    Application.Exit()
                ElseIf str_result = "NOMATCH" Then 'different machineprint
...
Re_Connect:
                ...
                MachinePrint = getMD5Hash(GetProcessorId())
                If MachinePrint = "" Then
                    Dim str_link2 As String = "http://www.mygoldensoft.com/notify.php"
                    str_link2 += "?para1=" + companyID
                    str_link2 += "&para2=" + ProductID
                    str_link2 += "&para3=" + ProductVer
                    str_link2 += "&para4=" + Reseller
                    Dim str_result2 As String = ""
                    str_result2 = GetPageHTML(str_link2).Trim
                    MsgBox("We cannot retrieve your machine fingerprint." + vbCrLf + "Please contact support@mygoldensoft.com", , ProductID)
                    Exit Sub
                End If
